...
public class Test {
    public static void main(String[] args) {
        String s1a = new String("a");
        String s1ae = "a";
        printAddresses("s1a", s1a);
        printAddresses("s1ae", s1ae);
        String s1b = new String("b");
        String s1be = "b";
        printAddresses("s1b", s1b);
        printAddresses("s1be", s1be);
        String s1 = s1a + s1b;
        printAddresses("s1", s1);
        s1.intern();
        printAddresses("s1.intern()", s1.intern());
        String s11 = new String("ab");
        printAddresses("s11", s11);
        s11.intern();
        printAddresses("s11.intern()", s11.intern());
        String s2 = "ab";
