...
@SupportedAnnotationTypes("categories.java.a8annotation.ToString")
...
public class ToStringAnnotationProcessor extends AbstractProcessor {
   ...
   public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment currentRound) {
      ...
      try 
      {
         JavaFileObject sourceFile = processingEnv.getFiler().createSourceFile("categories.java.a8annotation.ToStrings");
         try (PrintWriter out = new PrintWriter(sourceFile.openWriter())) {
            out.println("// Automatically generated by categories.java.a8annotation.ToStringAnnotationProcessor");
            out.println("package categories.java.a8annotation;");
