...
@SupportedAnnotationTypes("java.base.a8annotation.ToString")
...
public class ToStringAnnotationProcessor extends AbstractProcessor {
   ...
   public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment currentRound) {
      ...
      try 
      {
         JavaFileObject sourceFile = processingEnv.getFiler().createSourceFile("java.base.a8annotation.ToStrings");
         try (PrintWriter out = new PrintWriter(sourceFile.openWriter())) {
            out.println("// Automatically generated by java.base.a8annotation.ToStringAnnotationProcessor");
            out.println("package java.base.a8annotation;");
